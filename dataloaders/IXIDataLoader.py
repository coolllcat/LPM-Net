...
def sort_ixi_dirs(names: List[str]) -> List[str]: 
    indices = sorted(
        range(len(names)), 
...
class IXIDataset(Dataset): 
    def __init__(self, root_dir: str, is_train: bool, mode1: str = 'T1', mode2: str = 'T2', transforms=None) -> None:
        ...
        sample_names = sort_ixi_dirs(sample_names) 
        ...
        print("IXI data split: train: {}, valid and test: {}".format(
...
if __name__ == '__main__':
    dataset = IXIDataset('/data/postgraduate/wmw/FusionDataset/IXI-T1-T2-PD', True)
