...
class MMWHS2017Dataset(Dataset): 
    def __init__(self, root_dir: str, is_train: bool, mode1: str = 'ct', mode2: str = 'mr', transforms=None) -> None:
        super().__init__() 
    ...
    def _load_image_and_label(sample_dir: str, mode1: str, mode2: str): 
        ...
        mode1_image_path = os.path.join(sample_dir, "{}_image_padded.nii.gz".format(mode1)) 
        mode1_image = sitk.GetArrayFromImage(sitk.ReadImage(mode1_image_path))

        mode2_image_path = os.path.join(sample_dir, "{}_image_padded.nii.gz".format(mode2)) 
...
if __name__ == '__main__':
    dataset = MMWHS2017Dataset('/data/postgraduate/wmw/FusionDataset/MMWHS2017_Heart_CT_MR', True)
