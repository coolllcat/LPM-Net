...
def sort_brats2020_dirs(names: List[str]) -> List[str]: 
    indices = sorted(
        range(len(names)), 
...
class BraTS2020Dataset(Dataset): 
    def __init__(self, root_dir: str, is_train: bool, mode1: str = 't1', mode2: str = 't2', transforms=None) -> None:
        super().__init__() 

        _supported_domains = ['t1', 't2', 'flair', 't1ce']
        ...
        sample_names = sort_brats2020_dirs(sample_names) 
        ...
        print("BraTS2020 data split: train: {}, valid and test: {}".format(
...
if __name__ == '__main__':
    dataset = BraTS2020Dataset('/data/postgraduate/wmw/FusionDataset/BraTS2020_Brain_MRI_MM', True)
